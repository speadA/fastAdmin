<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"D:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/home\view\home\index.html";i:1598497894;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8">
	...
	<body>
				...
				<article class="col-md-8 col-sm-7 col-xs-12">
					<figure class="vedio-box">
						...
						<div class="vd-pic-box">
							...
							<img class="vd-pic" src="/new_assets/img/banner.jpg">
				...
				<section class="container">
					<div class="lay-nav">
						...
						<ul class="nav-item r">
							...
							<li>
								<a href="list.html">TRAVEL NEWS</a>
								<span></span>
							</li>
							<li>
								<a href="list.html">DESTINATION</a>
								<span></span>
							</li>
							<li>
		...
		<section class="banner">
			<ul class="banner-in">
				<li class="banner-item col-md-3 col-sm-6 col-xs-12">
					<img src="/new_assets/img/banner.jpg">
					<span class="bg-tag">DESTINATION</span>
					<article class="bg-text">
						<h3>The Best Hikes in Every State</h3>
						<a href="javascript:void(0)">
							<i class="iconfont icon-shijian"></i>AUGUST 13, 2020
						</a>
					</article>
					<div class="bg-pop"></div>
				</li>
				<li class="banner-item col-md-3 col-sm-6 col-xs-12">
					<img src="/new_assets/img/banner2.jpg">
					<span class="bg-tag">DESTINATION</span>
					<article class="bg-text">
						<h3>I Visited Cancun Amid the Coronavirus Pandemic — Here’s What It Was Really Like</h3>
						<a href="javascript:void(0)">
							<i class="iconfont icon-shijian"></i>AUGUST 13, 2020
						</a>
					</article>
				...
				<li class="banner-item col-md-3 col-sm-6 col-xs-12">
					<img src="/new_assets/img/banner3.jpg">
					<span class="bg-tag">DESTINATION</span>
					<article class="bg-text">
						<h3>The Best Hikes in Every State</h3>
						<a href="javascript:void(0)">
				...
				<article class="col-md-8 col-sm-7 col-xs-12">
					...
					<ul class="art-group">
						<li>
							...
							<div class="art-pic">
								<a href="javascript:void(0)">
									<img src="/new_assets/img/travel8-360x180.jpg">
								</a>
							</div>
							<figure class="art-in">
								<div class="art-cont">
									...
									<a class="read-more" href="detail.html">Read more</a>
								</div>
							</figure>
						</li>
						<li>
