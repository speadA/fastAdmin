<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:87:"D:\phpstudy\PHPTutorial\WWW\fastadmin\public/../application/index\view\index\index.html";i:1561449177;}*/ ?>
<!DOCTYPE html>
<html>
    ...
    <head>
        ...
        <title>DevinLee - <?php echo __('The fastest framework based on ThinkPHP5 and Bootstrap'); ?></title>
    ...
    <body id="page-top">
        ...
        <footer>
            <div class="container">
                ...
                <p>&copy; 2017-2018 <a href="https://www.fastadmin.net" target="_blank">DevinLee</a>. All Rights Reserved.</p>
