<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\phpstudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\member\add.html";i:1560846317;s:80:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\layout\default.html";i:1540985180;s:77:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\meta.html";i:1540985180;s:79:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\script.html";i:1540985180;}*/ ?>
<!DOCTYPE html>
...
<script type="text/javascript">
    ...
    <!--<div class="form-group">-->
        ...
        <!--<div class="col-xs-12 col-sm-8">-->
            <!--<input id="c-head_img" class="form-control" name="row[head_img]" type="text">-->
        <!--</div>-->
    <!--</div>-->
    <div class="form-group">
        <label class="control-label col-xs-12 col-sm-2"><?php echo __('Head_img'); ?>:</label>
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                <input id="c-head_img" data-rule="required" class="form-control" size="50" name="row[Head_img]" type="text" value="">
                <div class="input-group-addon no-border no-padding">
                    ...
                    <!--<span><button type="button" id="fachoose-head_img" class="btn btn-primary fachoose" data-input-id="c-head_img" data-mimetype="head_img/*" data-multiple="false"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>-->
                </div>
