<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:84:"D:\phpStudy\PHPTutorial\WWW\fastadmin\public/../application/home\view\home\list.html";i:1597990671;}*/ ?>
<!DOCTYPE html>
<html lang="en">
	<head>
		<meta charset="UTF-8">
	...
	<body>
		...
		<!-- adv in mobile -->
		<div class="adv-area">
			<img src="img/ad_345x345.jpg" width="300" height="250">
		</div>
			...
			<div class="container index-container">
				<article class="col-md-8 col-sm-7 col-xs-12">
					<ul class="art-group list-group">
						<li>
							<h3 class="art-tit">
								<a href="javascript:void(0)">10 Best Balinese Food Neighborhood Foods You Must Try WhenVisiting Bali</a>
								<dl class="art-by">
									<dt class="art-author">
										<span>by</span><a class="art-action" href="javascript:void(0)">admin</a>
									</dt>
									<dt class="art-time">
							...
							<div>
								<div class="art-pic">
									<a href="javascript:void(0)">
										<img src="./img/travel8-360x180.jpg">
									</a>
								</div>
								<figure class="art-in">
									<div class="art-cont">
										
										<p class="art-line">A great many islands with various societies make up Indonesia, so it's no big surprise
											that Balinese food is similarly...</p>
						...
						<li>
							<h3 class="art-tit">
								<a href="javascript:void(0)">Top 10 Vacation Spots</a>
								<dl class="art-by">
									<dt class="art-author">
										<span>by</span><a class="art-action" href="javascript:void(0)">william</a>
									</dt>
									<dt class="art-time">
										<a href="javascript:void(0)"><i class="iconfont icon-shijian"></i>SUPTEMBER 31, 2020</a>
									</dt>
									<dt class="art-time">
										<a href="javascript:void(0)"><i class="iconfont icon-pinglun"></i>2</a>
									</dt>
								</dl>
							</h3>
							<div>
								...
								<figure class="art-in">
									<div class="art-cont">
										...
										<p class="art-line">Need some motivation to design your next outing? Plan a definitive excursion at these best 10 get-away spots the world over. Paris, France Like every single extraordinary city</p>
										<a class="read-more" href="javascript:void(0)">Read more</a>
									</div>
								</figure>
							</div>
				...
				<div class="row">
					...
					<div class="col-md-3">
						...
						<ul class="footer-news">
							<li>
								<img class="footer-news-img" src="img/travel8-360x180.jpg">
		...
		<script src="js/pagenation.js" type="text/javascript" charset="utf-8"></script>
