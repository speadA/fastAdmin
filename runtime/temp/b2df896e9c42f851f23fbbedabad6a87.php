<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:84:"D:\phpstudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\test\add.html";i:1560837836;s:80:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\layout\default.html";i:1540985180;s:77:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\meta.html";i:1540985180;s:79:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\script.html";i:1540985180;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="form-group">
        ...
        <div class="col-xs-12 col-sm-8">
            <div class="input-group">
                ...
                <div class="input-group-addon no-border no-padding">
                    <span><button type="button" id="plupload-attachfile" class="btn btn-danger plupload" data-input-id="c-attachfile"
                                  data-multiple="false" data-preview-id="p-attachfile"><i class="fa fa-upload"></i> <?php echo __('Upload'); ?></button></span>
                    <span><button type="button" id="fachoose-attachfile" class="btn btn-primary fachoose" data-input-id="c-attachfile"
                                  data-multiple="false"><i class="fa fa-list"></i> <?php echo __('Choose'); ?></button></span>
                </div>
