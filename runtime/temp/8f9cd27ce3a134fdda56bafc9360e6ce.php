<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:86:"D:\phpstudy\PHPTutorial\WWW\fastadmin\public/../application/admin\view\test\index.html";i:1543394675;s:80:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\layout\default.html";i:1540985180;s:77:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\meta.html";i:1540985180;s:79:"D:\phpstudy\PHPTutorial\WWW\fastadmin\application\admin\view\common\script.html";i:1540985180;}*/ ?>
<!DOCTYPE html>
                ...
                <div class="widget-body no-padding">
                    <div id="toolbar" class="toolbar">
                        ...
                        <a href="javascript:;"
                           ...
                           title="测试添加" ><i class="fa fa-plus"></i> 测试添加</a>
                        <a href="javascript:;"
                           class="btn btn-success btn-testa"
                           title="测试添加" ><i class="fa fa-plus"></i> 测试添加
                        </a>
                        <a href="javascript:;"
                           class="btn btn-success btn-testb"
                           title="测试添加" ><i class="fa fa-plus"></i> 测试添加b
                        </a>
                        <button class="btn btn-success"
                                onclick="showBox('新增用户','test/register',50,60)"><i class="layui-icon">&#xe608;</i> 新增用户
                        </button>
